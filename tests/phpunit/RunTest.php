...
class RunTest extends AbstractTestClass
{
	...
	public function testRunAction(): void
	{
        ...
        copy(__DIR__ . '/../data/csv/language-large.csv', $this->dataDir->getTmpFolder() . '/in/files/language-large.csv');
	...
	public function testRunWithListAction(): void
	{
		...
		$this->assertEquals(0, $process->getExitCode());
		$this->assertMatchesRegularExpression('/File language-with-list.csv - Export finished/ui', $process->getOutput());
		$this->assertEquals(1, $this->parseBatchCountFromOutput($process->getOutput()));
